<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Editar o usuário: <?php echo $usuarioSelecionado->nome; ?></h1>
        </div>
    </div><!--/.row-->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <?php echo form_open(base_url() . 'index.php/cadastraUsuario/editarUsuario?idUsuario=' . $usuarioSelecionado->id); ?>

                        <div class="form-group">
                            <label>Nome do Usuario</label>
                            <input name="nome" class="form-control" placeholder="João Paulo Barnabé da Silva" required="true" value="<?php echo $usuarioSelecionado->nome; ?>">
                        </div>

                        <div class="form-group">
                            <label>Login</label>
                            <input name="login" class="form-control" placeholder="joao.silva" required="true" value="<?php echo $usuarioSelecionado->login; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>Status do Usuário</label>
                            <input id="status" type="checkbox" name="status" class="form-control" required="true" value="<?php echo $usuarioSelecionado->status;?>" <?php echo $usuarioSelecionado->status == 1 ? 'checked' : ''; ?>> Esta ativo?
                        </div>
